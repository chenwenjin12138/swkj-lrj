...
public class Constants {
     ...
     * 订单追踪状态用户设定类型
     */
    public static final int ORDER_TRACESTATUSUSERDIY = 2;
    /** 默认密码 **/
    ...
    /** 订单未支付 **/
    public static final int ORDER_NONPAYMENT = 1;
    /** 订单已支付 **/
    public static final int ORDER_PAYMENT = 2;
    /** 订单支付失败 **/
    public static final int ORDER_PAYMENTFAILED = 3;
    /** 订单未抢 **/
    public static final int ORDER_UNLOCK = 1;
    /** 订单已抢 **/
    public static final int ORDER_LOCK = 2;
    /** 订单退款 **/
