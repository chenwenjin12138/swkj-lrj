...
public class AppItem {
    ...
    public void setCategoryName(String categoryName) {
        ...
        this.categoryName = categoryName; // 支持java的数据设置
    }

    public void setCategory_name(String category_name) {

        this.categoryName = category_name; // 支持mysql(或单个单词java)的数据设置;
    }

    public void setCATEGORY_NAME(String CATEGORY_NAME) {

        this.categoryName = CATEGORY_NAME; // 支持oracle的数据设置;
    }

    public String getCategoryName() {

        return categoryName; // 支持java的数据读取;
    }

    public String getCategory_name() {

        return categoryName; // 支持库脚本(或单个单词java)的数据读取
    }
