...
<!--autocomplete-->
<link rel="stylesheet"
	href="css/item/jquery.autocomplete.css"
	type="text/css"></link>
<link rel="stylesheet"
	href="css/item/styles.css" type="text/css"></link>
<!--autocomplete-->
<link rel="stylesheet"
	href="css/item/uploadify.css" type="text/css"></link>
<link rel="stylesheet" href="css/item/default.css"
	type="text/css"></link>
<!-- page content -->
<div id="main-content">
	<!-- title begin -->
			...
			<form id="frm-edit-item" class="form-horizontal">
				...
				<div class="widget-body paddingAll">
					...
					<div class="text-right">
						...
						<button
							onclick="javascript:window.location.href='localhost:8081/item/init-list?unfolder=item-init-list'+getReturnURLparam()"
...
<script type="text/javascript"
	src="js/item/jquery.autocomplete.js"></script>
<!--autocomplete-->
<!--file upload-->
<script type="text/javascript"
