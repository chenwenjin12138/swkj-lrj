	...
	<div class="sidebar-scroll">
		<div id="sidebar" class="nav-collapse collapse">
			...
			<ul class="sidebar-menu">
				...
				<li class="sub-menu" id="mainMenu"><a href="main" class=""><i class="icon-dashboard"></i>
						<span>主菜单</span> </a></li>
				<li style="display: none;" class="sub-menu"><a href="javascript:;" class=""> <i class="icon-cog"></i> <span>后台管理</span>
						<span class="arrow"></span> </a>
					<ul class="sub">
						<li id="admin-init-list"><a class="" href="toAccountManangemet">帐号管理</a>
						</li>
						<li id="role-init-list"><a class="" href="toRoleManagement">角色管理</a>
						</li>
						<li id="authority-init-list"><a class="" href="toAuthorityManagement">角色管理</a>
						</li>
					</ul></li>
				...
				<li style="display: none;" class="sub-menu"><a href="javascript:;" class=""> <i class="icon-barcode"></i> <span>订单管理</span>
					...
					<ul class="sub">
						...
						<%-- <li id="yearsServiceOrder-init-list"><a class=""
							href="yearsServiceOrder/init-list?unfolder=yearsServiceOrder-init-list">包期订单管理</a>
						</li> --%>
				...
				<li style="display: none;" class="sub-menu"><a href="javascript:;" class=""> <i class="icon-comments-alt"></i>
						...
						class="arrow"></span> </a>
					<ul class="sub">
						<li id="doubleEleven-init-list"><a class="" href="doubleEleven/init-list?unfolder=doubleEleven-init-list">双十一活动</a>
						</li>
						<li id="wxMonthCard-init-list"><a class="" href="wxMonthCard/init-list2?unfolder=wxMonthCard-init-list">月卡管理</a>
						</li>
						<li id="feed-back-init-list"><a class="" href="feed-back/init-list?unfolder=feed-back-init-list">用户反馈管理</a>
						</li>
						<li id="message-init-list"><a class="" href="message/init-list?unfolder=message-init-list">用户消息管理</a>
						</li>
						<li id="app-push-init-list"><a class="" href="app-push/init-list?unfolder=app-push-init-list">用户消息推送</a>
						</li>
						<li id="orderComment-init-list"><a class="" href="orderComment/init-list?unfolder=orderComment-init-list">用户评论管理</a>
						</li>
					</ul></li>
				...
				<li style="display: none;" class="sub-menu"><a href="javascript:;" class=""> <i class="icon-cog"></i> <span>字典管理</span><span
					...
					<ul class="sub">
						<li id="orderTagDic-init-list"><a class=""
							href="orderTagDic/init-list?unfolder=orderTagDic-init-list">订单字典管理</a>
						</li>
						<li id="bankDic-init-list"><a class="" href="bankDic/init-list?unfolder=bankDic-init-list">银行字典管理</a>
						</li>
						<li id="valueAddedServices-init-list"><a class="" href="valueAddedServices/init-list?unfolder=valueAddedServices-init-list">增值服务管理</a>
						</li>
					</ul></li>
				...
				<li style="display: none;" class="sub-menu"><a href="javascript:;" class=""> <i class="icon-credit-card"></i>
					...
					<ul class="sub">
						<li id="withdrawApply-init-list"><a class=""
							href="withdrawApply/init-list?unfolder=withdrawApply-init-list">提现记录</a>
						</li>
				...
				<li style="display: none;" class="sub-menu"><a href="javascript:;" class=""> <i class="icon-bar-chart"></i>
					...
					<ul class="sub">
						<li id="orderStatistics-init-list"><a class=""
							href="orderStatistics/init-list?unfolder=orderStatistics-init-list">订单统计</a>
						</li>
						<li id="userStatistics-init-list"><a class=""
							href="userStatistics/init-list?unfolder=userStatistics-init-list">用户统计</a>
						</li>
				...
				<li style="display: none;" class="sub-menu"><a href="javascript:;" class=""> <i class="icon-dashboard"></i>
					...
					<ul class="sub">
						<li id="apk-init-list"><a class="" href="apk/init-list?unfolder=apk-init-list">Android包管理</a></li>
				...
				<li style="display: none;" class="sub-menu"><a href="javascript:;" class=""> <i
                    ...
                    <ul class="sub">
                        <li id="wc-country-list"><a class="" href="worldcup/init-list?unfolder=wc-country-list">竞猜活动</a>
                        </li>
                        <%--<li id="wc-user-list"><a class="" href="apk/init-list?unfolder=wc-country-list">竞猜用户</a>--%>
                        <%--</li>--%>
                    </ul>
                </li>
				...
				<li style="display: none;" class="sub-menu"><a href="javascript:;" class=""> <i class="icon-sitemap"></i> <span>分销管理(商家)</span><span
					...
					<ul class="sub">
						<li id="businessBankCard-init-list"><a class=""
							href="businessBankCard/init-list?unfolder=businessBankCard-init-list">我的银行卡</a>
						</li>
						<li id="myEarnings-init-list"><a class=""
							href="myEarnings/init-list?unfolder=myEarnings-init-list">我的收益</a></li>
