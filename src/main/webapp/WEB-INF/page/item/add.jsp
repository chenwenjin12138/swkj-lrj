...
<!--autocomplete-->
<link rel="stylesheet" href="static/item/css/jquery.autocomplete.css" type="text/css"></link>
<link rel="stylesheet" href="static/item/css/styles.css" type="text/css"></link>
<!--autocomplete-->
<link rel="stylesheet" href="static/item/css/uploadify.css" type="text/css"></link>
<link rel="stylesheet" href="static/item/css/default.css" type="text/css"></link>
<!-- page content -->
<div id="main-content">
	<!-- title begin -->
										...
										<div class="span6">
											...
											<div class="controls">
												<input id="image" type="file" name="image"> <img style="display: none" id="image_show" src=""
													...
													src="/static/item/img/98fff0986f_24.png"> <input type="hidden" name="picture" id="url" />
											</div>
										</div>
										<div class="span6">
...
<script type="text/javascript" src="business-js/item/add.js"></script>
