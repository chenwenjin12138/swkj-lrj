...
<!--autocomplete-->
<link rel="stylesheet" href="assets/autocomplete/jquery.autocomplete.css" type="text/css"></link>
<link rel="stylesheet" href="assets/autocomplete/styles.css" type="text/css"></link>
<!--autocomplete-->
<link rel="stylesheet" href="assets/uploadify3/uploadify.css" type="text/css"></link>
<link rel="stylesheet" href="assets/uploadify3/default.css" type="text/css"></link>
<!-- page content -->
<div id="main-content">
	<!-- title begin -->
			...
			<form id="frm-add-item" class="form-horizontal">
				...
				<div class="widget-body paddingAll">
								...
								<div class="widget-body">
									...
									<div class="row-fluid">
										...
										<div class="span6">
											...
											<div class="controls positionfu">
												<input readonly="readonly" type="text" class="input-block-level"
													id="itemCategoryName" name="itemCategoryName" value="爆品"> <input type="hidden" id="itemCategoryId"
													name="itemCategoryId" value="17">
											</div>
										...
										<div class="span6">
											...
											<div class="controls">
												<input id="image" type="file" name="image"> <img style="display: none" id="image_show" src=""
													...
													src="assets/uploadify3/98fff0986f_24.png"> <input type="hidden" name="picture" id="url" />
											</div>
										</div>
										<div class="span6">
									...
									<div class="row-fluid">
										<div class="span6">
											...
											<div class="controls">
												<input class="input-block-level" type="text" placeholder="促销产品的原价" id="promotionOriginalCost"  name="promotionOriginalCost" />
											</div>
										</div>
										<div class="span6">
											<label class="control-label"> 促销开始日期： </label>
											<div class="controls">
												<input id="promotionBeginDate" type="text" name="promotionBeginDate"
													onClick="WdatePicker({dateFmt:'yyyy-M-d'})" readonly="readonly"  class="input-block-level"/>
											</div>
									...
									<div class="row-fluid">
										<div class="span6">
											...
											<div class="controls">
												<input id="promotionEndDate" type="text" name="promotionEndDate"
												onClick="WdatePicker({dateFmt:'yyyy-M-d'})" readonly="readonly" class="input-block-level"/>
											</div>
					...
					<div class="text-right">
						...
						<button onclick="javascript:window.location.href='localhost:8080/item/init-list?unfolder=item-init-list'+getReturnURLparam()"
...
<!--autocomplete-->
<!--file upload-->
<script type="text/javascript" src="assets/uploadify3/jquery.uploadify.min.js"></script>
<script type="text/javascript" src="business-js/item/common.js"></script>
<script type="text/javascript" src="business-js/base.js"></script>
<script type="text/javascript" src="business-js/item/addHot.js"></script>
