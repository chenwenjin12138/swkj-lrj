			...
			<div class="span12">
				<div class="control-group">
					<div class="text-left">
						...
						<a href="javascript:location.href='localhost:8080/item/init-add?unfolder=item-init-list'+'&'+$('#item_query').serialize();"
							role="button" class="btn" data-toggle="modal"> <i class="icon-plus"> </i> 新增 </a>
						<a href="javascript:location.href='localhost:8080/item/init-addHot?unfolder=item-init-list'+'&'+$('#item_query').serialize();"
...
<!--autocomplete-->
<script type="text/javascript" src="assets/autocomplete/jquery.autocomplete.js">
	
</script>
<link rel="stylesheet" href="assets/autocomplete/jquery.autocomplete.css" type="text/css">
</link>
<link rel="stylesheet" href="assets/autocomplete/styles.css" type="text/css">
</link>
<!--autocomplete-->
...
<script type="text/javascript" src="business-js/item/list.js"></script>
