...
<!-- include css -->
<%@ include file="/index/template-css.jsp"%>
</head>
	...
	<div id="header" class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand"> <img src="img/logo_xiyi.png" alt="Metro Lab" /> </a> <a
				...
				<div class="top-nav ">
					<ul class="nav pull-right top-menu">
						...
						<li class="dropdown mtop5"><a id="" class="dropdown-toggle element" data-placement="bottom"
							data-toggle="tooltip" href="admin/loginOut" data-original-title=""> <span class="wz">退 出</span>
						</a>
						</li>
					</ul>
				</div>
