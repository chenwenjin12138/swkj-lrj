...
<!--autocomplete-->
<link rel="stylesheet" href="<%=basePath%>assets/autocomplete/jquery.autocomplete.css" type="text/css"></link>
<link rel="stylesheet" href="<%=basePath%>assets/autocomplete/styles.css" type="text/css"></link>
<!--autocomplete-->
<link rel="stylesheet" href="<%=basePath%>assets/uploadify3/uploadify.css" type="text/css"></link>
<link rel="stylesheet" href="<%=basePath%>assets/uploadify3/default.css" type="text/css"></link>
<!-- page content -->
<div id="main-content">
	<!-- title begin -->
			...
			<form id="frm-add-item" class="form-horizontal">
				...
				<div class="widget-body paddingAll">
										...
										<div class="span6">
											...
											<div class="controls">
												<input id="image" type="file" name="image"> <img style="display: none" id="image_show" src=""
													...
													src="<%=basePath%>assets/uploadify3/98fff0986f_24.png"> <input type="hidden" name="picture" id="url" />
											</div>
										</div>
										<div class="span6">
					...
					<div class="text-right">
						...
						<button onclick="javascript:window.location.href='<%=basePath%>item/init-list?unfolder=item-init-list'+getReturnURLparam()"
...
<!--autocomplete-->
<script type="text/javascript" src="<%=basePath%>assets/autocomplete/jquery.autocomplete.js"></script>
<!--autocomplete-->
<!--file upload-->
<script type="text/javascript" src="<%=basePath%>assets/uploadify3/jquery.uploadify.min.js"></script>
...
<script type="text/javascript" src="<%=basePath%>business-js/item/addHot.js"></script>
